...
export default function DrinksTable(props: IDrinksTableProps) {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "rgba(255, 255, 255, 0.864)" }}>
            <img style={{display: "flex", justifyContent: "center", alignItems: "center", width: "7%" }} src={titleImg} />
