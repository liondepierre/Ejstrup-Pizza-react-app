...
import rightIcon from '../assets/img/TriangleRight12.svg';
import leftIcon from '../assets/img/TriangleLeft12.svg';
...
export default function SlideShow(props: ISlideShowProps) {
    return (
        <div style={{ position: "relative", width: "100%", height: "100%", display: "flex", gap: "5%", justifyContent: "center", alignItems: "center", flexDirection: "row" }}>
            ...
            <img style={{ fill: "cyan", bottom: "1", right: "0", position: "absolute", width: "10%", height: "10%"}} src={rightIcon} alt="gå til højre"/>
