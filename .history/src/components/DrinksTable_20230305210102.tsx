    ...
    return (
        <div style={{backgroundColor: "rgba(255, 255, 255, 0.659)"}}>
            ...
            {drinks.map((drink: IDrink) => {
                return (
                    <div style={{fontWeight: "bold", fontSize: "25px", fontFamily: "Sans Serif", display: "flex", gap: "0.6%", flexDirection: "row", alignItems: "center", justifyContent: "center" }} key={drink.id}>
                        <p>{drink.size}</p>
                        <p>{drink.brands}....................................... </p>
                        <p>{drink.price} kr.</p>
                    </div>
