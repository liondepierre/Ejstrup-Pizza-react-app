...
export default function Home(props: IHomeProps) {
    ...
    const loopSlideShowPhotos = (): IPhotos[] => {
        const loadPhotos: IPhotos[] = [
            {
        ...
        <div className={styles.homeRoot}>
            ...
            <div className={styles.squares}>
                ...
                <div className={styles.rightSquare}>
                    <img src='src/assets/img/slideshowImages/foodImage.jpg' alt='foodImage'/>
                    {/* {slideShowPhotos.map((photo: IPhotos) => {
                        return (
                            <div>
                                fkso
