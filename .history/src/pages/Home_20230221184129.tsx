            ...
            <div className={styles.squares}>
                ...
                <div className={styles.rightSquare}>
                    <div style={{ display: 'flex', justifyContent: 'center', flexDirection: "column" }}>
                        ...
                        <FacebookEmbed url="https://www.facebook.com/ejstrupholm.grill/posts/pfbid02iPsQSbXmn4VJ6opRVGoz72uXQ7ap9mLXCwx7kZ1kWJe1HCvZ5NR4UYYHFNUFu79Ul" width={500} height={00} />
                    </div>
                </div>
            </div>
        </div>
