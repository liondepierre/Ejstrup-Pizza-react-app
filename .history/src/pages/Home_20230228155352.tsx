...
import { DrinksProvider } from '../providers/server';
        ...
        <div className={styles.homeRoot}>
            ...
            <div className={styles.squares}>
                ...
                <div className={styles.rightSquare}>
                    <div style={{ display: 'flex', gap: "3px", justifyContent: 'center', flexDirection: "column", alignItems: "start" }}>
                        <div style={{ marginTop: "6%" }}>
                            <FacebookEmbed url="https://www.facebook.com/ejstrupholm.grill/posts/pfbid0c7YbSUzgLCpc2kUngMMik3n5LrebzGergoddV7cdb5ZRMjpfkb9xBoejxLGv89g6l"
