            ...
            <div className={styles.squares}>
                ...
                <div className={styles.rightSquare}>
                    <div style={{ display: 'flex', justifyContent: 'center', flexDirection: "column" }}>
                        <FacebookEmbed url="https://www.facebook.com/ejstrupholm.grill/posts/pfbid0c7YbSUzgLCpc2kUngMMik3n5LrebzGergoddV7cdb5ZRMjpfkb9xBoejxLGv89g6l" width={500} height={300} />
