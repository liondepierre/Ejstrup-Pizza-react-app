...
import menuCard from '../assets/img/slideshowImages/menuCard.jpg'
import restaurantImage from '../assets/img/slideshowImages/restaurantImage.jpg'
        ...
        <div className={styles.homeRoot}>
            ...
            <div className={styles.squares}>
                <div className={styles.leftSquare}>
                    <SlideShow photo={photos} currentIndex={0}/>
                </div>
