...
export default function Home(props: IHomeProps) {
    const [phoneNumber, setPhoneNumber] = React.useState<string>("75 77 30 29");


    const onPhoneNumberClicked = (): string => {
        navigator.clipboard.writeText(phoneNumber)

        alert(`kopieret telefonummeret ${phoneNumber}`)
        return phoneNumber;
    }
            ...
            <div className={styles.squares}>
                ...
                <div className={styles.middleSquare}>
                    <div className={styles.generalInfo}>
                        ...
                        <div onClick={() => onPhoneNumberClicked()} id='telephone' className={styles.field}>
