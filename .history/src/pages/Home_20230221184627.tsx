            ...
            <div className={styles.squares}>
                ...
                <div className={styles.rightSquare}>
                    <div style={{ display: 'flex', justifyContent: 'center', flexDirection: "column", gap: "50px" }}>
                        ...
                        <iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2Fejstrupholm.grill%2Fposts%2Fpfbid0c7YbSUzgLCpc2kUngMMik3n5LrebzGergoddV7cdb5ZRMjpfkb9xBoejxLGv89g6l&show_text=true&width=500" width="500" height="410"></iframe>
