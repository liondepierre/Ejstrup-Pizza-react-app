    ...
    return (
        <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", border: "3px solid black", margin: "0.5%", padding: "1%" }}>
                ...
                <div style={{ display: "flex", justifyContent: "center", margin: "1%", border: "3px solid black" }}>
                    <h1>Hello World</h1>
                </div>
                {drinks.map((drink) => (
                    <div style={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", gap: "5%", padding: "1%", border: "3px solid black" }} key={drink.id}>
